...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <style>
            ...
            html {background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)),url("/images/background3.png");}
        </style>
    </head>
    ...
    <body>
        ...
        <div class="w3-bar w3-amber w3-round w3-card-4">
            <a href="<?php echo e(route('mainpage')); ?>" class="w3-button w3-hover-none w3-padding-16 w3-large">MyTutor</a>
            <a href="<?php echo e(route('logout')); ?>" class="w3-right w3-bar-item w3-button w3-padding-16 w3-hover-none w3-border-amber w3-bottombar w3-hover-border-white w3-hover-text-white w3-normal">Logout</a>
        </div>
        ...
        <table class="w3-table w3-hoverable w3-centered w3-striped w3-bordered w3-white w3-responsive w3-card" style="border-radius:25px;table-layout:auto;width:90%;margin:auto;">
            ...
            <tr>
                ...
                <td style="width:15%;white-space: nowrap; text-overflow:ellipsis; overflow: hidden; max-width:1px;"><?php echo e($subject->title); ?></td>
                <td style="width:40%;white-space: nowrap; text-overflow:ellipsis; overflow: hidden; max-width:1px;"><?php echo e($subject->description); ?></td>
                <td style="width:5%">RM<?php echo e($subject->price); ?></td>
                <td style="width:20%"><?php echo e($subject->hours); ?> Hours</td>
            </tr>
        ...
        <div id="newSubject" class="w3-modal w3-animate-opacity">
            <div class="w3-modal-content w3-round" style="width:500px;border-radius:25px">
                <header class="w3-row w3-amber" style="border-radius:25px 25px 0px 0px">
                    <div class="w3-row">
                        <span onclick="document.getElementById('newSubject').style.display='none'" class="w3-button w3-right w3-display-toprightw3-small">&times;</span>
...
<?php /**PATH C:\Users\Acer\Documents\Semester 4\STIW3044 Web Engineering\Laravel\myTutor\resources\views/mainpage.blade.php ENDPATH**/ ?>